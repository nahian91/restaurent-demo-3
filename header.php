				...
				<div class="col-xl-2 col-lg-2 col-md-4 col-3 p-0">
		            <div class="navbar-header">
			               	<a class="navbar-brand page-scroll" href="index.php">
			                	<img alt="pizzon" src="assets/images/header-logo.png">
			                </a> 
		            </div>
			    </div>
			    <div class="col-xl-7 col-lg-7 col-md-7 col-7 p-0 text-right">
			        <div id="menu" class="navbar-collapse collapse" >
			            <ul class="nav navbar-nav">
				            ...
				            <li class="level">
				                <a href="order-online.php" class="page-scroll">Order online</a>
				            </li>
				            <li class="level">
				                <a href="gallery.php" class="page-scroll">Gallery</a>
				            </li>
				            <li class="level">
				                <a href="reservation.php" class="page-scroll">Reservation</a>
				            </li>
				            <li class="level">
				                ...
				                <div class="cart-dropdown header-link-dropdown">
				                    <ul class="cart-list link-dropdown-list">
				                      	<li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
				                        	<div class="media"> <a href="shop-detail.html" class="pull-left"> <img alt="Pizzon" src="assets/images/1.png"></a>
				                      	...
				                      	<li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
				                        	<div class="media"> <a class="pull-left"> <img alt="Pizzon" src="assets/images/2.png"></a>
