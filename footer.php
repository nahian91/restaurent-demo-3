					...
					<div class="col-xl-4 col-lg-4 col-md-4 footer-box">
						<div class="footer-logo">
							...
							<ul>
								...
								<li>email  - <a href="/cdn-cgi/l/email-protection#bac9cfcacad5c8cefacad3c0c0d5d494d9d5d7"><span class="__cf_email__" data-cfemail="f2818782829d8086b2829b88889d9cdc919d9f">[email&#160;protected]</span></a></li>
							</ul>
						</div>
					</div>
			...
			<div class="copyright">
				<div class="row">
					<div class="col-xl-6 col-lg-6 col-md-6 copyright-box">
						<p class="copy-text">© Pizzon all Rights Reserved. Designed by <a href="https://templatescoder.com/" target="_blank">TemplatesCoder</a></p>
					</div>
